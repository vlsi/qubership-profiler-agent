...
public class Tomcat10RequestHandler extends MethodInstrumenter implements Opcodes {
    ...
    public MethodInstrumenter init(Element e, Configuration_01 configuration) {
        ...
        final List def = er.getEnhancers("com/netcracker/profiler/instrument/enhancement/Tomcat10HTTPEnhancer");
        if (def.isEmpty()) {
