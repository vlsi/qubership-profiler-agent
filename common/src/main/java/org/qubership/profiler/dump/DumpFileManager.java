...
public class DumpFileManager implements Closeable {
    ...
    /**
     * Deletes the {@code file} completely from the corresponding {@link org.qubership.profiler.dump.DumpRoot}
     * @param file {@link org.qubership.profiler.dump.DumpFile} to be deleted
