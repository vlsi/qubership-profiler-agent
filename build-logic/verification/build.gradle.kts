...
dependencies {
    ...
    implementation("com.github.spotbugs:com.github.spotbugs.gradle.plugin:6.1.13")
    ...
    implementation("org.checkerframework:org.checkerframework.gradle.plugin:0.6.55")
}
